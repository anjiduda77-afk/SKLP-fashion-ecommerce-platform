...
router.post('/items/:itemId/move-to-wishlist', asyncHandler(cartController.moveToWishlist))
router.get('/coupons', asyncHandler(cartController.getAvailableCoupons))
